...
export function NewProjectModal({ open, onOpenChange }: NewProjectModalProps) {
  ...
  const [placementAccepted, setPlacementAccepted] = useState<boolean | null>(
    null
  );
  ...
  const quickPrompts = [
    ...
    {
      id: 4,
      text: "Help me define project objectives for a residential development",
      field: "objectives",
    },
    {
      id: 5,
      text: "What stakeholders should I include for a commercial build?",
      field: "stakeholders",
    },
    { id: 6, text: "Help me identify potential project risks", field: "risks" },
    {
      id: 7,
      text: "Suggest success criteria for the project",
  ...
  const extractedData = [
    ...
    {
      label: "Plot Size / Area Statement",
      value: "120,000 sq ft",
      field: null,
    },
    {
    ...
    {
      label: "Key Dates",
      value: "Start: 2025-01-01, Completion: 2025-12-31",
      field: null,
    },
    {
      label: "Permits & Approvals Required",
      value: "NYC DOB, Health Dept",
      field: null,
    },
    { label: "Estimated Project Cost / Budget", value: "$2.5M", field: null },
    {
      label: "Stakeholders",
      value: "Architect, Contractor, Consultants, PMC",
      field: null,
    },
  ];
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Kick off real extraction via API
  ...
  const simulateExtraction = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "AI has extracted and populated the project information from your documents.",
      });
  ...
  const extractFromFile = async (file: File) => {
    ...
    try {
      ...
      // Hide extraction dialog shortly after completion
      setTimeout(() => {
        setIsExtracting(false);
        setExtractionProgress(0);
        setVisibleFields([]);
      ...
      toast({
        ...
        description: err?.message || "Unable to extract data from the file.",
        variant: "destructive",
      });
    } finally {
      if (progressTimer) {
  ...
  const aiResponseTemplates: { [key: number]: string } = {
    ...
    6: "Potential risks for the NYC Tower healthcare project:\n\n• Regulatory Delays: Permit approval timeline uncertainty with NYC DOB and Health Department\n• Budget Overruns: Material cost fluctuations in current market, especially for specialized medical equipment\n• Schedule Constraints: Weather-related delays during construction phases\n• Supply Chain Issues: Long lead times for specialized medical equipment and healthcare-specific materials\n• Stakeholder Coordination: Multiple approval layers may slow decision-making processes\n• Code Compliance: Complex healthcare facility regulations may require design modifications\n• Site Conditions: Potential unforeseen underground utilities or soil conditions\n• Labor Availability: Skilled trades shortage in NYC market\n• Quality Control: Stringent medical facility standards require enhanced oversight",
    7: "Success criteria for the NYC Tower healthcare project:\n\n• Project completed on time by Q4 2025 and within the $2.5M approved budget\n• All regulatory approvals obtained without major delays from NYC DOB and Health Department\n• LEED Gold certification achieved demonstrating sustainable design excellence\n• Client satisfaction score above 4.5/5 throughout project lifecycle\n• Zero major safety incidents during construction phase\n• Successful commissioning of all medical systems and equipment\n• Smooth handover and operational readiness for healthcare operations\n• All 120,000 sq ft delivered meeting or exceeding quality standards\n• Stakeholder alignment maintained with <5% change orders\n• Post-occupancy energy performance meets or exceeds design targets",
  };
              ...
              <div className="space-y-4">
                ...
                {showSuccessMessage && (
                  <div className="bg-green-50 border border-green-200 rounded-lg p-3 flex items-center gap-2 animate-in fade-in slide-in-from-top-2">
                    ...
                    <p className="text-xs text-green-800 font-medium">
                      Fields have been updated with extracted information from
                      your documents!
                    </p>
                  </div>
                )}
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Drop files and I'll extract the project name, client,
                        location, and current stage. You'll review before
                        saving.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      {formData.projectId && (
                        <p className="text-[10px] text-muted-foreground">
                          Extracted from uploaded docs source:{" "}
                          {selectedFileName ?? "—"}
                        </p>
                      )}
                    </div>
                    ...
                    {/* Design Stage */}
                    <div className="space-y-1">
                      <Label htmlFor="designStage" className="text-xs">
                        Design Stage
                      </Label>
                      <Input
                        id="designStage"
                  ...
                  <p className="text-[10px] text-muted-foreground">
                    AI suggestions are based on your imported files. You can
                    adjust anytime.
                  </p>
                </div>
              </div>
                  ...
                  <div className="flex-1 flex flex-col bg-muted/30 rounded-lg overflow-hidden">
                    ...
                    <div className="flex items-center gap-2 p-3 border-b bg-white/50">
                      <div>
                        ...
                        <p className="text-[10px] text-muted-foreground">
                          Smart project charter generation
                        </p>
                      </div>
                    </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      Enterprise baseline is ready. I'll classify files and
                      propose folders. You control confirmations.
                    </p>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-4 space-y-3">
                      ...
                      <div className="bg-blue-100/50 rounded-md p-3 space-y-2">
                        <p className="text-xs font-medium">
                          I suggest locations for 4 file(s). Accept to place
                          them.
                        </p>
                        <div className="flex items-center gap-2">
                          <Button
                      ...
                      <div className="bg-blue-100/50 rounded-md p-3 space-y-2">
                        <p className="text-xs font-medium">
                          Proposed placements for 4 file(s).
                        </p>
                        <div className="flex items-center gap-2">
                          <Button
                            size="sm"
              ...
              <div className="space-y-6">
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Please review all project details before creating your
                    project
                  </p>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="confirm" className="text-xs text-gray-700">
                      ...
                      <span className="block mt-1 text-muted-foreground">
                        ...
                        reviewed all project details and are ready to create the
                        project. This will initialize the project repository and
