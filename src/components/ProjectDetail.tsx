          ...
          <Tabs defaultValue="overview" className="flex-1">
            ...
            <TabsContent value="overview" className="mt-0">
              <div className="relative flex">
                ...
                {/* AI Assistant Right Sidebar - Only in Overview */}
                <div 
                  className={`fixed right-0 top-[73px] w-96 h-[calc(100vh-73px)] bg-background border-l shadow-lg transition-transform duration-300 flex flex-col ${
                    isAiSidebarOpen ? 'translate-x-0' : 'translate-x-full'
                  }`}
                  style={{ maxWidth: '384px', zIndex: 40 }}
                >
                  {/* Header */}
                  ...
                  {/* Greeting Section */}
                  <div className="p-6 bg-gradient-to-br from-construction-primary/5 to-construction-accent/5 border-b">
                    <div className="flex items-start gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-construction-primary to-construction-accent flex items-center justify-center shrink-0">
                        <span className="text-white text-lg">👋</span>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-foreground mb-1">Hello! How can I help?</p>
                        <p className="text-xs text-muted-foreground">
                          I can help you with project insights, schedule optimization, cost analysis, and more.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 border-b">
                    ...
                    <div className="space-y-2">
                      <Button 
                        variant="outline" 
                        size="sm" 
                        className="w-full justify-start text-xs h-auto py-3 hover:bg-construction-primary/5 hover:border-construction-primary"
                      >
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    <div className="text-center py-8">
                      <p className="text-sm text-muted-foreground">Start a conversation or select a suggested prompt</p>
                    </div>
                  </div>
